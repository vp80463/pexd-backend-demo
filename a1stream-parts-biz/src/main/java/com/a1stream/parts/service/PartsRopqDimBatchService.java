...
@Service
public class PartsRopqDimBatchService {
    ...
    public void dimBatch(String siteId
                        ,String processDate
        ...
        for (Long facilityId  : facilityIdList) {
            ...
            this.dimRopqBatch(siteId, facilityId, processDate);
        }

        // update batch sign to two
        this.updateSystemParameterInfo(siteId, SystemParameterType.INITIALBATCHFLAG, CommonConstants.CHAR_TWO);

        // Set last monthly batch date
        this.updateSystemParameterInfo(siteId, SystemParameterType.LASTDAILYBATCH, lastDailyDate);

        // Set last monthly batch date
        this.updateSystemParameterInfo(siteId, SystemParameterType.LASTMONTHLYBATCH, processDate);

        // Set current finance month
        this.updateSystemParameterInfo(siteId, SystemParameterType.CURRENTFINANCEMONTH, lastYYMM);

        // Set last mi collection date
        this.updateSystemParameterInfo(siteId, SystemParameterType.LASTMICOLLECTDATE, lastDailyDate);

        // Stop Batch Process, Set Batch Process Flag off
        this.updateSystemParameterInfo(siteId, SystemParameterType.BATCHPROCESSFLAG, CommonConstants.CHAR_ZERO);
    }

    public void dimRopqBatch(String siteId
                            ,Long facilityId
                            ,String processDate) {
        log.info("Start Batch Process by facilityId : " + siteId);
        //Timer
        StopWatch timer = new StopWatch();

        //SD beginning stock collect
        timer.start("1. SD beginning stock collection");
        this.doSDBeginningStockCollectCalculate(siteId
                                                                      , facilityId
                                                                      , processDate);
        timer.stop();

        //SP beginning stock collect
        timer.start("2. SP beginning stock collection");
        this.doBeginningStockCollectCalculateByPoint(siteId
                                                                           , processDate
                                                                           , facilityId);
        timer.stop();
        ...
        Map<Long, Long> fromProductIdMap = this.getfromProductId(CommonConstants.CHAR_DEFAULT_SITE_ID);

        //Connection product_abc_info,abc_definition_info type ABCN
        List<PartsBatchBO> productIdMapListData = this.getProductRegisterdate(CommonConstants.CHAR_DEFAULT_SITE_ID, keyProductIdMap);

        timer.stop();
        // J1,J2 calculate
        timer.start("1. J1J2Collection");
        Map<String, DemandForecastBatchBO> demfortempMap = this.doJ1J2Collection(siteId
                                                                                            , processDate
                                                                                            , facilityId
                                                                                            , fromProductIdMap
        ...
        this.doCostUsageCalculate(siteId
                                               , processDate
                                               , facilityId
                                               , fromProductIdMap
                                               , demfortempMap
        ...
        List<ProductAbcBatchBO> productAbcModelList  = this.getProductTypeABCN(siteId
                                                                                          , facilityId
                                                                                          , productAbcMap
                                                                                          , demfortempMap
...
//
        ...
        this.doAverageDemandCalculate(siteId
                                                  , facilityId
                                                  , processDate
                                                  , productFacilityFeatureList
                                                  , keyProductIdMap);
        ...
        this.doDeviationMonthCalculate(siteId
                                                 , facilityId
                                                 , processDate
                                                 , productAbcMap
                                                 , demfortempMap);
        ...
        this.doSafetyStockMonthCalculate(siteId
                                                     , facilityId
                                                     , processDate
                                                     , productAbcModelList);
        timer.stop();
        ...
        this.doTrendIndexCalculate(siteId
                                              , facilityId
                                              , processDate
                                              , productFacilityFeatureList);
        timer.stop();
        ...
        this.doSeasonIndexCalculate(siteId
                                               , facilityId
                                               , processDate
                                               , demfortempMap);
        timer.stop();
//
        ...
        this.doDemandForecastCalculate(siteId
                                                  , facilityId
                                                  , processDate
                                                  , fromProductIdMap
                                                  , productFacilityFeatureList);
      ...
      //Release the variables in this method.
        ...
        this.updateNewPointSign(siteId, facilityId);

        log.info("Summary of monthly batch of site "+siteId+" is following: End of Monthly Batch");
    }
    ...
    public Map<String, DemandForecastBatchBO> doJ1J2Collection(String siteId
        ...
        TimerUtil.startTask(timer, "Prepare data");
        int prdSize = productIdList.size();
        ...
        for (PartsBatchBO partsBatchBO : productIdList) {
            ...
            if (isJustThisYear) {
                ...
                if(j1YearMap == null) {
                    j1YearMap = selectJdbcDao.getProductOrderResultSummaryByTargetYear(siteId, facilityId, j1Year);
                }
        ...
        deleteAndInsertProductFacilityFeature(siteId, facilityId, resultMap);
        TimerUtil.endTask(timer, log);
    ...
    public void doCostUsageCalculate(String siteId
        ...
        Map<Long,List<CuProductInfoBatchBO>> orgModelMapList = this.getProductsGroupbyFacility(facilityId,CommonConstants.CHAR_DEFAULT_SITE_ID);
        // get product cost
        ...
        insertProductAbc(siteId, facilityId, resultMap);
        TimerUtil.endTask(taskTimer, log);
    ...
    public void doAverageDemandCalculate(String siteId
        ...
        insertPartsRopqMonthlyFacPro(siteId, facilityId, resultMap,RopRoqParameter.KEY_PARTSAVERAGEDEMAND);
    ...
    public void doDeviationMonthCalculate(String siteId
        ...
        //1. Delete rows in DB.
        updateJdbcDao.deletePartsRopqMonthlyDataAndFacility(siteId, facilityId, RopRoqParameter.KEY_PARTSDEVIATIONMONTH);

        List<Object[]> batchArgs = new ArrayList<Object[]>();

        log.info(productAbcMap.size() + " ProcudtAbc records to be calculated");

        Map<String, String> averageMonthDemandMap = selectJdbcDao.getPartsRopqMonthlyMapString(siteId,facilityId,RopRoqParameter.KEY_PARTSAVERAGEDEMAND);
...
//            facilityId = proFac[0];
    ...
    public void doSafetyStockMonthCalculate(String siteId
        ...
        reorderGuidelineMap        = selectJdbcDao.getReorderGuideline(siteId,facilityId);
        reorderGuidelineMapFlagOne = selectJdbcDao.getReorderGuidelineFlagIsOne(siteId,facilityId);
        productFacilityFeatureMap  = selectJdbcDao.getPartsRopqMonthlyMap(siteId,facilityId,RopRoqParameter.KEY_PARTSDEVIATIONMONTH);
        ...
        insertPartsRopqMonthlyFacPro(siteId, facilityId, resultMap,RopRoqParameter.KEY_SPARTSSAFETYSTOCKMONTH);
        //Release resources.
        if(resultMap != null) {
            resultMap.clear();
            resultMap = null;
        ...
        //Process inserting features.
        insertPartsRopqMonthlyByRopMonth(siteId, facilityId, ropmonthResultMap);
        //Release resources.
    ...
    public void doTrendIndexCalculate(String siteId
        ...
        updateJdbcDao.deletePartsRopqMonthlyDataAndFacility(siteId, facilityId, RopRoqParameter.KEY_PARTSTRENDINDEX);
        StopWatch timer = new StopWatch();
        timer.start();
    ...
    public void doSeasonIndexCalculate(String siteId
        ...
        List<String> facprocate = selectJdbcDao.getSeasonIndex(siteId,facilityId);
        List<PartsBatchBO> productOrderResultSummaryMapList = selectJdbcDao.getProductABCCategory(siteId,facilityId);
        ...
        insertSeasonIndex(siteId,facilityId, resultMap);
    ...
    public void doDemandForecastCalculate(String siteId
        ...
        List<ProductAbcBatchBO> productAbcModelList = selectJdbcDao.getAbcType(siteId,facilityId);
        ...
        Map<String, SiSeasonIndexInfoModelBO> seasonIndexMap = selectJdbcDao.getSeasonIndexInfoMap(siteId,facilityId);
        Map<String, SiSeasonIndexInfoModelBO> seasonIndexManualMap = selectJdbcDao.getSeasonIndexManualInfoMap(siteId,facilityId);
        ...
        updateJdbcDao.deleteTableDemandforecastFacility(siteId, facilityId);
        SnowflakeIdWorker snowflakeIdWorker = IdUtils.getSnowflakeIdWorker();
    ...
    public void doRopRoqCalculate(String siteId
        ...
        List<RrDemandForecastMonthItemBatchBO> demandForecastList = getDemandForcastList(siteId, facilityId, productAbcModelMap, hasFromProductFacToProds, rrDemandForecastMonthItemMap);

        Map<String,Object[]> resultMap = new HashMap<String,Object[]>();
        log.info(rrDemandForecastMonthItemMap.size() + " ROP ROQ to be calculated");

        //Get monthly ROP by parts'.
        Map<String, SsmProductAbcBatchBO> ropMonthMap = selectJdbcDao.getPartsRopqMonthlyMap(siteId, facilityId, RopRoqParameter.KEY_PARTSROPMONTH);

        // get reorderGuideline data
        Set<String> facproList = selectJdbcDao.getReorderGuidelineMap(siteId,facilityId);
        ...
        Set<String> facPrdIds = selectJdbcDao.getProductTypeDEXY(siteId,facilityId); //Type is D,E,XX,YY
        ...
        insertReorderGuideline(siteId,facilityId,resultMap);
        TimerUtil.endTask(taskTimer, log);
    ...
    public void insertReorderGuideline(String siteId
        ...
        //Delete rows.
         updateJdbcDao.deleteTableReorderGuidelineFacility(siteId,facilityId);
    ...
    public List<ProductAbcBatchBO> getProductTypeABCN(String siteId
        ...
        List<ProductAbcBatchBO> productAbcModelList =  selectJdbcDao.getProductProductAbcTypeABCN(siteId,facilityId);
    ...
    private List<RrDemandForecastMonthItemBatchBO> getDemandForcastList(String siteId,
        ...
        List<RrDemandForecastMonthItemBatchBO>  demandForecastList = selectJdbcDao.getDemandForecast(siteId,facilityId);
    ...
    private void insertSeasonIndex(String siteId
        ...
        //Delete rows.
        updateJdbcDao.deleteSeasonIndexInfoForFacility(siteId,facilityId);
...
//                if (StringUtil.equals(siProductOrderResultSummaryModel.getTargetyear(), yearDate)) {
    ...
    */
    ...
    private void insertPartsRopqMonthlyByRopMonth(String siteId
        ...
        //1. Delete rows.
        updateJdbcDao.deletePartsRopqMonthlyDataAndFacility(siteId, facilityId, RopRoqParameter.KEY_PARTSROPMONTH);
    ...
    private void insertPartsRopqMonthlyFacPro(String siteId
        ...
        //1. Delete rows in DB.
        updateJdbcDao.deletePartsRopqMonthlyDataAndFacility(siteId, facilityId, ropqType);
    ...
    private void insertProductAbc(String siteId
        ...
        doInsertProductAbcRows(siteId, facilityId, resultObject);
    }
     ...
     * @param resultObject
     */
    private void doInsertProductAbcRows(String siteId,Long facilityId, Map<String, String[]> resultObject) {
      ...
      updateJdbcDao.deleteTableProductAbcByFacility(siteId, facilityId);
        int batchSize = CommonConstants.DB_OP_BATCH_SIZE;
        List<Object[]> batchArgs = new ArrayList<Object[]>();
 ...
 // GET TYPE IN KEEPING WITH A,B,C DATE
    ...
    private Map<Long,List<CuProductInfoBatchBO>> getProductsGroupbyFacility(Long facilityId
                                                                           ,String siteId){
    ...
    private void deleteAndInsertProductFacilityFeature(String siteId
        ...
        updateJdbcDao.deletePartsRopqMonthlyDataAndFacility(siteId, facilityId, RopRoqParameter.KEY_PARTSJ1TOTAL);
        updateJdbcDao.deletePartsRopqMonthlyDataAndFacility(siteId, facilityId, RopRoqParameter.KEY_PARTSJ2TOTAL);
        SnowflakeIdWorker snowflakeIdWorker = IdUtils.getSnowflakeIdWorker();
    ...
    public void updateNewPointSign(String siteId
        ...
        updateJdbcDao.updateNewPointSign(siteId, facilityId);
    }

    public void updateSietMst(String siteId) {

        updateJdbcDao.updateSiteMst(siteId);
    }


    public void updateSystemParameterInfo(String siteId
                                        , String sysParamTypeId
                                        , String parameterValue) {

        // Set last monthly batch date
        int count = this.setSpecParameterValue(siteId
                                             , sysParamTypeId
                                             , parameterValue);
