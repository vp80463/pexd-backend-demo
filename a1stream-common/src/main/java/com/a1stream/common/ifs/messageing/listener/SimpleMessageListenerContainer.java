...
import com.a1stream.common.ifs.messageing.AmazonSQSIllegalStateException;
import com.a1stream.common.ifs.messageing.AmazonSQSStartupException;
...
public class SimpleMessageListenerContainer extends AbstractMessageListenerContainer {
    ...
    public SimpleMessageListenerContainer(SqsClient amazonSQS){
    ...
    private BlockingQueueConsumer createBlockingQueueConsumer() {
        ...
        int waitTimeSeconds = getWaitTimeSeconds();
        int maxNumberOfMessages = getMaxNumberOfMessages();
        int actualPrefetchCount = getPrefetchCount() > this.txSize ? getPrefetchCount() : this.txSize;
        BlockingQueueConsumer consumer = new BlockingQueueConsumer(getAmazonSQS(), getTaskExecutor(), queueName,waitTimeSeconds,maxNumberOfMessages, actualPrefetchCount);
        return consumer;
    }
