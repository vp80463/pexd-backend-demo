 ...
 * @author dong zhen
 */
@WebServiceClient(name = "PublishService", targetNamespace = "http://tempuri.org/", wsdlLocation = "classpath:wsdl/publishserviceNT.wsdl")
public class PublishServiceNT extends Service {
...
//            url = new URL(baseUrl, "file:/usr/local/wildfly-9.0.2.Final/publishserviceNT.wsdl");
            url = PublishServiceDN.class.getClassLoader().getResource("wsdl/publishserviceNT.wsdl");
            if (url == null) {
    ...
    public PublishServiceNT(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public PublishServiceNT() {
