...
public class SDM0306Service {
    ...
    public CmmEmployeeInstructionVO getCmmEmployeeInstructionVO(Long employeeInstructionId) {

        return BeanMapUtils.mapTo(cmmEmployeeInstructionRepository.findByCmmEmployeeInstructionId(employeeInstructionId), CmmEmployeeInstructionVO.class);
    }
    ...
    public SDM030601BO save(SDM030601Form form) {
        ...
        salesOrderVO.setEmployeeCd(formData.getEmployeeCd());
        ...
        salesOrderItemVO.setSellingPrice(formData.getSellingPrice().multiply(formData.getEmployeeDiscount()));
        BigDecimal sellingPriceNotVat = salesOrderItemVO.getSellingPrice().divide(taxRate);
        salesOrderItemVO.setSellingPriceNotVat(sellingPriceNotVat);
        salesOrderItemVO.setActualAmt(salesOrderItemVO.getSellingPrice());
        ...
        CmmEmployeeInstructionVO cmmEmployeeInstructionVO = this.getCmmEmployeeInstructionVO(formData.getCmmEmployeeInstructionId());
        cmmEmployeeInstructionVO.setOrderNo(salesOrderVO.getOrderNo());
        cmmEmployeeInstructionVO.setOrderStatus(SalesOrderStatus.WAITING_SHIPPING.getCodeDbid());
        cmmEmployeeInstructionVO.setLocalOrderId(salesOrderVO.getSalesOrderId());
        cmmEmployeeInstructionVO.setOrderDate(salesOrderVO.getOrderDate());
        cmmEmployeeInstructionVO.setSiteId(salesOrderVO.getSiteId());
        cmmEmployeeInstructionRepository.save(BeanMapUtils.mapTo(cmmEmployeeInstructionVO, CmmEmployeeInstruction.class));
