...
public class SDM0304Service {
    ...
    public SDM030401BO save(SDM030401Form form) {
        ...
        salesOrderItemVO.setSellingPrice(formData.getSpecialPrice());
        BigDecimal sellingPriceNotVat = formData.getSpecialPrice().divide(taxRate);
        salesOrderItemVO.setSellingPriceNotVat(sellingPriceNotVat);
        salesOrderItemVO.setSpecialPrice(formData.getSpecialPrice());
