...
public class SDM0302Service {
    ...
    public SDM030201BO delivery(SDM030201Form form) {
        ...
        salesOrderVO.setOrderType(MCSalesType.RETAILSALESORDER);
        ...
        SalesOrderItemVO salesOrderItemVO = SalesOrderItemVO.create(form.getSiteId(), salesOrderVO.getSalesOrderId());
        ...
        salesOrderItemVO.setAllocatedQty(salesOrderItemVO.getAllocatedQty().add(BigDecimal.ONE));
