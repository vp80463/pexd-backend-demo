...
@Entity
@Table(name="cmm_serialized_product")
@Setter
@Getter
public class CmmSerializedProduct extends BaseEntity {
    ...
    @Column(name="refuse_call", length=1)
    private String refuseCall;

    @Column(name="original_site_id", length=10)
    private String originalSiteId;

    @Column(name="original_facility_id")
